...
<template>
  <a-card :bordered="false">
    ...
    <a-table :dataSource="tableList" :pagination="pagination" @change="handleTableChange" :loading="loading" rowKey="id">
        ...
        <a-table-column title="应用程序标识" dataIndex="applicationId" />
...
export default {
  ...
  methods: {
    getDataList(){
      this.loading = true;
      axios.get("api/Roleinterface",{params : this.queryParam}).then(res=>{
    ...
    handleDel(id){
        axios.delete('api/Roleinterface/' + id).then(res => {
