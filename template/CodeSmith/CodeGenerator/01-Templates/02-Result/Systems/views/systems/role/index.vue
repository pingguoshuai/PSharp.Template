  ...
  <a-card :bordered="false">
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="48">
          ...
          <a-col :md="8" :sm="24">
            <a-form-item label="IsAdmin">
              <a-select v-model="queryParam.isAdmin" placeholder="请选择" default-value="">
                <a-select-option value="">全部</a-select-option>
                <a-select-option value="true">是</a-select-option>
                <a-select-option value="false">否</a-select-option>
              </a-select>
    ...
    <a-table :dataSource="tableList" :pagination="pagination" @change="handleTableChange" :loading="loading" rowKey="id">
        ...
        <a-table-column title="SortId" dataIndex="sortId" />
          <a-table-column title="IsAdmin" dataIndex="isAdmin">
...
export default {
  ...
  methods: {
    getDataList(){
      this.loading = true;
      axios.get("api/Role",{params : this.queryParam}).then(res=>{
