<template>
    <a-card :bordered="false">
                ...
                <a-row :gutter="48">
                    ...
                    <a-col :md="8" :sm="24">
                        <a-form-item label="医院简称">
                            <a-input v-model="queryParam.abbreviation" placeholder="请输入医院名称" />
                        </a-form-item>
                    </a-col>
                    <a-col :md="8" :sm="24">
                        <a-form-item label="医院编码">
                            <a-input v-model="queryParam.code" placeholder="请输入医院名称" />
                        </a-form-item>
                    </a-col>
                    <a-col :md="8" :sm="24">
        ...
        <a-table
            ...
            rowKey="id"
        >
            <a-table-column title="医院名称" dataIndex="name" />
            <a-table-column title="医院简称" dataIndex="abbreviation" />
            <a-table-column title="医院编码" dataIndex="code" />
            <a-table-column title="医院排序" dataIndex="sortId" />
...
export default {
    ...
    methods: {
        ...
        handleDel(id) {
            axios.delete('Hospital/' + id).then(res => {
