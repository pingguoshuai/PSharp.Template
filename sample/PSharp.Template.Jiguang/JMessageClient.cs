using PSharp.Template.Jiguang.Message;
using PSharp.Template.Jiguang.Common;
using PSharp.Template.Jiguang.User;
using PSharp.Template.Jiguang.Report;
...
using PSharp.Template.Jiguang.Group;
using PSharp.Template.Jiguang.Chatroom;

namespace PSharp.Template.Jiguang
{
